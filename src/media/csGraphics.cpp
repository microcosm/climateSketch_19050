...
void csGraphics::loadFiles(string baseFilename, int count, vector<ofxTexturePlane>& collection, csLoadingMode mode){
    string fileIndex;
...
void csGraphics::updateSkylines(){
...
void csGraphics::draw(ofEventArgs &e){
    //Layer 1
    masker.beginLayer(0);
    {
...
void csGraphics::keyPressed(int key){
    if(key == ' '){
